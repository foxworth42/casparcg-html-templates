...
describe("CasparCG template data parser", () => {
    it("Should successfully parse valid template data from CasparCG", () => {
        ...
        let parsedTemplateData = testHandler.parseTemplateData('{"title": "Title", "subtitle": "Subtitle"}');
    ...
    it("Should return an empty object if template data is not valid JSON", () => {
        let testHandler = new TemplateHandler();
        let parsedTemplateData = testHandler.parseTemplateData("<templateData></templateData>");
...
describe("Template parameter handler", () => {
    it("Should should successfully populate text for parameters that match", () => {
        ...
        expect(document.querySelector("[data-param='title']").textContent).toBe("Title");
        expect(document.querySelector("[data-param='subtitle']").textContent).toBe("Subtitle");
    });
    ...
    it("Should clear text and add empty-field class if parameter is empty", () => {
        ...
        `;
        expect(document.querySelector("[data-param='title']").classList.contains("empty-field")).toBe(false);
        expect(document.querySelector("[data-param='title']").textContent).toBe("Some Title");
        let testHandler = new TemplateHandler();
        testHandler.fillParameters({
            "title": ""
        });

        expect(document.querySelector("[data-param='title']").classList.contains("empty-field")).toBe(true);
        expect(document.querySelector("[data-param='title']").textContent).toBe("");
    });
    ...
    it("Should remove empty-field class if new content is not empty", () => {
        ...
        expect(document.querySelector("[data-param='title']").classList.contains("empty-field")).toBe(false);
        expect(document.querySelector("[data-param='title']").textContent).toBe("New Title");
    });
    ...
    it("Should leave parent element alone by default if parameter is empty", () => {
        ...
        `;
        expect(document.querySelector("#titleParent").classList.contains("empty-wrapper")).toBe(false);
    ...
    it("Should add empty-wrapper class to parent element if parameter is empty and hideParentOnEmpty flag is true", () => {
        ...
        expect(document.querySelector("#titleParent").classList.contains("empty-wrapper")).toBe(true);
    });
    ...
    it("Should handle updating images in templates", () => {
        ...
        `;
        expect(document.querySelector("[data-param='logo']").src).toContain("logo.png");
